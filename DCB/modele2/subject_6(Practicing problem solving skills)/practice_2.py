...
class User():
    ...
    def getFullName(self):
        return f'{self.name} {self.surname} {self.secondname}'
...
class Student(User):
    ...
    def getCourse(self):
        ...
        return 'Окончил обучение или еще не поступал'


St = Student('Alex', 'Alex1', 'Alex2', Student.year_of_admission)
print(St.getFullName())
print(St.getCourse())
